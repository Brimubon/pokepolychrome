...
static void NewGameBirchSpeech_CreateDialogueWindowBorder(u8 bg, u8 x, u8 y, u8 width, u8 height, u8 palNum)
{
    ...
    FillBgTilemapBufferRect(bg, 0x0FD, x-2,       y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, 0x0FF, x-1,       y-1, 1,       1, palNum);
    ...
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(0x0FD), x-2,       y+height, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(0x0FF), x-1,       y+height, 1,       1, palNum);
