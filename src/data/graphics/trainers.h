...
const u32 gTrainerFrontPic_AlphaGrunt1[] = INCBIN_U32("graphics/trainers/front_pics/alpha_grunt_1.4bpp.smol");
const u16 gTrainerPalette_AlphaGrunt1[] = INCBIN_U16("graphics/trainers/front_pics/alpha_grunt_1.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_ALPHA_GRUNT_1, gTrainerFrontPic_AlphaGrunt1, gTrainerPalette_AlphaGrunt1),
};
...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN, 5, gTrainerBackPic_Brendan, gTrainerBackPicPalette_Brendan, sBackAnims_Brendan),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY, 5, gTrainerBackPic_May, gTrainerBackPicPalette_May, sBackAnims_May),
