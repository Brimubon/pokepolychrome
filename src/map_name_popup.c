...
static const u8 sMapPopUpForest[] = INCBIN_U8("graphics/map_popup/forest.4bpp");
static const u16 sMapPopUpForestPal[] = INCBIN_U16("graphics/map_popup/forest.gbapal");
...
static const u8 * const sMapPopUp_Table[] =
{
    ...
    [MAPPOPUP_THEME_FOREST]     = sMapPopUpForest,
};
...
static const u16 * const sMapPopUp_PaletteTable[] =
{
    ...
    [MAPPOPUP_THEME_FOREST]     = sMapPopUpForestPal,
};
...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_HONEYDEW_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_301 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_ROUTE,
    [MAPSEC_MULBERRY_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MULBERRY_WOODS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_FOREST,
};
