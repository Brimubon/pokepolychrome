...
static void PrintMonStats()
{
    ...
    // note: it seems givemons that are not properly assigned an ability will cause a bug where the ability name doesn't show up. maybe look into how summary screen prints abilities and copy that later
